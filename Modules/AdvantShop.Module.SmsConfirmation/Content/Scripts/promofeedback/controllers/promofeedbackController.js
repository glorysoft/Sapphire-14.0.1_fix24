; (function (ng) {
    ...
    var PROMOFeedbackCtrl = function ($http, toaster) {
        ...
        ctrl.send = function (form) {
            if (form.$valid)
            {
                $http.post('../module/smsConfirmationAdmin/feedback', { feedback: ctrl.feedback }).then(function (response) {
    ...
    ng.module('promofeedback',[])
        ...
        .component('promoFeedback', {
            templateUrl: '../modules/SmsConfirmation/content/scripts/promofeedback/templates/promofeedback.html',
