...
{
    public class GetRarClientsHandler
    {
        private readonly RarClientFilterModel _filterModel;
        private SqlPaging _paging;

        public GetRarClientsHandler(RarClientFilterModel filterModel)
        {
            _filterModel = filterModel;
        }

        public FilterResult<RarClient> Execute()
        {
            var model = new FilterResult<RarClient>();
            ...
            model.DataItems = _paging.PageItemsList<RarClient>();
        ...
        private void GetPaging()
        {
            ...
            _paging.From("Module.RemindAboutReceiptClients");
