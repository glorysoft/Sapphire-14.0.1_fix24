; (function (ng) {
    ...
    var RarModuleClientsListCtrl = function ($uibModal, uiGridConstants, uiGridCustomConfig, SweetAlert, $q) {
        var ctrl = this;
        ...
        var columnDefs = [
            ...
            },
            {
                ...
                cellTemplate:
                    ...
                    '<ui-grid-custom-delete url="../module/raradmin/deleteClient" params="{\'id\': row.entity.Id }"></ui-grid-custom-delete>' +
                    '</div></div>'
            }
        ];
                ...
                selectionOptions: [
                    {
                        ...
                        url: '../module/raradmin/deleteClients',
                        field: 'Id',
                        before: function () {
        ...
        ctrl.loadClient = function (id) {
            $uibModal.open({
                ...
                controller: 'ModalAddEditRarClientCtrl',
                controllerAs: 'ctrl',
                templateUrl: '../modules/RemindAboutReceipt/content/scripts/clientsList/modal/AddEditRarClient.html',
                resolve: {
                    id: function () {
                        return id;
                    }
    ...
    RarModuleClientsListCtrl.$inject = ['$uibModal', 'uiGridConstants', 'uiGridCustomConfig', 'SweetAlert', '$q'];

    ng.module('RARModuleSettings', [])
        .controller('RarModuleClientsListCtrl', RarModuleClientsListCtrl)
        .component('rarModuleClientsList', {
            templateUrl: '../modules/RemindAboutReceipt/content/scripts/clientsList/templates/clientsList.html',
            controller: 'RarModuleClientsListCtrl'
        });
