...
Qazy.prototype.imgOK = function (img) {
    var isLoad = img.complete && img.src.length > 0 && img.naturalWidth > 0;
...
Qazy.prototype.searchImages = function (selectorSearch) {
    ...
    list.forEach(function (element) {
        if (!self.imgOK(element) && !isElementInViewport(element) && !element.classList.contains('js-qazy-loading') && element.src !== self.placeholder) {
