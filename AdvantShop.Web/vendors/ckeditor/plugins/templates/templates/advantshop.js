        ...
        [
            {
                ...
                html: '<div class="block-img-left clear"><div class="wrapper-img"><img src="./images/nophoto.png" alt="" style="float:left; margin-right: 10px;"></div><h3>Заголовок</h3><div>Здесь текст</div></div>'
            },
            {
                title: "Заголовок с текстом и картинка",
                image: "template1.gif",
                description: "Одна картинка с заголовком и текст, который обтекает картинку.",
                html: '<div class="clear"><img src="./images/nophoto.png" alt="" style="float:right; margin-left: 10px;"><h3>Заголовок</h3><div>Здесь текст</div></div>'
            },
            {
