    ...
    signalR.fn = signalR.prototype = {
        ...
        _parseResponse: function (response) {
            ...
            if (!response) {
                ...
                var json = that.json.parse(response);
                var withoutDomain = that.baseUrl.replace(that.protocol + '//' + that.host, '');
                var urlNew = json.Url.replace(withoutDomain, "");
                json.Url = urlNew;
                return json;
            } else {
                return response;
        ...
        start: function (options, callback) {
            ...
            var connection = this,
                ...
                setConnectionUrl = function (connection, url) {
                    ...
                    connection.baseUrl = connection.url.replace('signalr', '');
                    //ENDCUSTOM
