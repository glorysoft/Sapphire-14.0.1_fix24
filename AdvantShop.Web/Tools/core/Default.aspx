...
<body>
    ...
    <asp:Panel ID="pnlcmd" runat="server">
        <fieldset style="margin-bottom: 22px; padding: 15px 15px 15px 15px;">
            ...
            <br />
            Critical css status:
            <b><asp:Label ID="lbStatusCriticalCss" runat="server" Text=""></asp:Label></b> 
            <asp:LinkButton ID="lnkRunCriticalCss" runat="server" OnClick="lnkRunCriticalCss_Click">Run critical css</asp:LinkButton>
            <br />
            <br />
            Critical css bundles:
            <asp:Label ID="lbCriticalCssBundles" runat="server" Text=""></asp:Label>
            <asp:LinkButton ID="lnkGetCriticalCssBundles" runat="server" OnClick="lnkGetCriticalCssBundles_Click">Get critical css bundles</asp:LinkButton>
        </fieldset>
