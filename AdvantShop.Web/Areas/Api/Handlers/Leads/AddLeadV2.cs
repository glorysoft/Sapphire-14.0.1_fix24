...
{
    public class AddLeadV2 : AbstractCommandHandler<AddLeadV2Response>
    {
        private readonly AddLeadV2Model _model;

        public AddLeadV2(AddLeadV2Model model)
        {
            _model = model;
        }
        ...
        private AddLeadV2Response Add()
        {
            ...
            var lead = new Lead()
            {
                ...
                Sum = _model.Sum,
                OrderSourceId = orderSource?.Id ?? 0,
            ...
            return new AddLeadV2Response() { LeadId = lead.Id };
        }

        protected override AddLeadV2Response Handle()
        {
            try
            {
                return Add();
