(function (ng) {
    ...
    const SubblockInplacePriceCtrl = function ($window, subblockInplaceService) {
        const ctrl = this;
        ...
        ctrl.showModal = function (modalId) {
            ...
            subblockInplaceService.showModal(modalId, 'Настройки цены', null, ctrl.modalSettingsBlockData.data).then(() => {
