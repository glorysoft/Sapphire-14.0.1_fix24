            ...
            try
            {
                ...
                if (method is UniversalPayGate)
                {
                    ...
                    if (curent != null)
                    {
                        ...
                        parameters[UniversalPayGateTemplate.NotificationUrl] = curent.NotificationUrl;
                        parameters[UniversalPayGateTemplate.SuccessUrl] = curent.SuccessUrl;
                        parameters[UniversalPayGateTemplate.CancelUrl] = curent.CancelUrl;
                        method.Parameters = parameters;
                    }
                }
                //End of dirty magic
