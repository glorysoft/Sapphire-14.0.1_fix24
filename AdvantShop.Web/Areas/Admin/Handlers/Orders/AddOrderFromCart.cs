...
namespace AdvantShop.Web.Admin.Handlers.Orders
{
    public class AddOrderFromCart : AbstractCommandHandler<int>
    {
        ...
        {
            _cart = ShoppingCartService.GetShoppingCartFromDb(ShoppingCartType.ShoppingCart, _customerId, false);
        }
        ...
        protected override int Handle()
        {
            ...
            try
            {
                ...
                order.Coupon =
                    _cart.Coupon != null && _cart.TotalPrice >= _cart.Coupon.MinimalOrderPrice
                        ? (OrderCoupon) _cart.Coupon
                        : null;
