    ...
    public class GetCustomerGroups
    {
        ...
        private void GetPaging()
        {
            ...
            _paging.Select(
                ...
                "GroupDiscount",
                "MinimumOrderPrice",
                (@"(SELECT COUNT(CustomerId) FROM Customers.Customer 
                    WHERE Customer.CustomerGroupId = CustomerGroup.CustomerGroupId AND Customer.CustomerRole = " + (int)Role.User + ")").AsSqlField("CustomersCount")
                );
