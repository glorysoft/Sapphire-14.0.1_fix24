...
{
    public class UpdateSizeChartHandler : ICommandHandler
    {
        private readonly SizeChartModel _model;

        public UpdateSizeChartHandler(SizeChartModel model)
        {
            _model = model;
        }
        ...
        public void Execute()
        {
            ...
            {
                throw new BlException(LocalizationService.GetResource("Admin.Catalog.SizeChart.UpdateError"));
            }
        }
    }
}