...
namespace AdvantShop.Web.Admin.Handlers.Marketing.Coupons
{
    public class GetCatalogForCoupons
    {
        ...
        private void GetPaging()
        {
            ...
            _paging
                .Select(
                    ...
                    "(Select ISNULL(CouponProducts.CouponId, 0))".AsSqlField("ApplyCoupon")
                )
        ...
        private void Filter()
        {
            ...
            if (_filterModel.ApplyCoupon != null)
            {
                _paging.Where(string.Format("CouponProducts.CouponId is {0} null", _filterModel.ApplyCoupon.Value ? "not" : ""));
            }
