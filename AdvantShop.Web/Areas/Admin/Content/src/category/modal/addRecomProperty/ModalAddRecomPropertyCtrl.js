...
(function (ng) {
    ...
    const ModalAddRecomPropertyCtrl = function ($uibModalInstance, $http, toaster) {
        const ctrl = this;
        ...
        ctrl.getProperties = function () {
            $http.get('category/getProperties').then((response) => {
        ...
        ctrl.getPropertyValues = function () {
            ...
            $http.get('category/getPropertyValues', { params: { propertyId: ctrl.property.PropertyId } }).then((response) => {
