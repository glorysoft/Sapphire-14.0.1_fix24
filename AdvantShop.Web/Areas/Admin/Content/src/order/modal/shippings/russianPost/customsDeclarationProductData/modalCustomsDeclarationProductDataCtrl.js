(function (ng) {
    ...
    const ModalRussianPostCustomsDeclarationProductDataCtrl = function ($uibModalInstance, uiGridCustomConfig) {
        const ctrl = this;
                    ...
                    uiGridCustomEdit: {
                        ...
                        editDropdownOptionsArray: [{ label: '----', value: '' }].concat(
                            Object.keys(ctrl.countriesCodes)
                                .sort((a, b) => ctrl.countriesCodes[a] < ctrl.countriesCodes[b] ? -1 : 1)
                                .map((countrycode) => ({ label: ctrl.countriesCodes[countrycode], value: countrycode })),
                        ),
                    },
                },
                {
