    ...
    var AngularColorPickerController = function () {
        ...
        createClass(AngularColorPickerController, [{
            ...
            value: function initMouseEvents() {
                ...
                this.$document[0].addEventListener('touchstart', eventHandlers.mouseDown, {passive: false});
                this.$document[0].addEventListener('touchend', eventHandlers.mouseUp, {passive: false});
                this.$document[0].addEventListener('touchmove', eventHandlers.mouseMove, {passive: false});
                ...
                this.$scope.$on('$destroy', function () {
                    ...
                    // remove touch events
                    _this3.$document[0].removeEventListener('touchstart', eventHandlers.mouseDown);
                    _this3.$document[0].removeEventListener('touchend', eventHandlers.mouseUp);
                    _this3.$document[0].removeEventListener('touchmove', eventHandlers.mouseMove);
