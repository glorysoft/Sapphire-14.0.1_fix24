    ...
    public class ExportFeedSettingsYandexDirectModel : IValidatableObject
    {
        public ExportFeedSettingsYandexDirectModel(ExportFeedYandexDirectOptions exportFeedYandexOptions)
        {
           ...
           //GlobalDeliveryCost = exportFeedYandexOptions.GlobalDeliveryCost;
            ...
            CollectionsDescriptionType = exportFeedYandexOptions.CollectionsDescriptionType;
            RemoveHtmlInCollectionsDescription = exportFeedYandexOptions.RemoveHtmlInCollectionsDescription;
        ...
        public Dictionary<string, string> CollectionsDescriptionTypeList =>
            new Dictionary<string, string>
            {
                {"none", LocalizationService.GetResource("Admin.ExportFeed.Settings.DontUseDescription")},
                {"full", LocalizationService.GetResource("Admin.ExportFeed.Settings.FullDescription")},
