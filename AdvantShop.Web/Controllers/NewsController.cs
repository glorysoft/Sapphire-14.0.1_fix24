    ...
    public partial class NewsController : BaseClientController
    {
        ...
        public ActionResult NewsCategory(string url, int? page)
        {
            ...
            var meta = newsCategory == null
                ? MetaInfoService.GetDefaultMetaInfo(MetaType.NewsCategory, null)
                : newsCategory.Meta;
            ...
            var model = new NewsCategoryViewModel
            {
                ...
                HideDate = SettingsNews.HideNewsDate
            };
        ...
        public ActionResult NewsItem(string url)
        {
            ...
            model.NewsProducts = new NewsProductsViewModel
            {
                ...
                {
                    CountProductsInLine =
                        newsItem.ProductsDisplayMode == News.NewsItem.ENewsProductsDisplayMode.Horizontally || newsItem.ProductsDisplayMode == News.NewsItem.ENewsProductsDisplayMode.Tile ? 3 : 1,
                    DisplayPhotoPreviews = false,
                    LazyLoadType = newsItem.ProductsDisplayMode != News.NewsItem.ENewsProductsDisplayMode.Tile ? eLazyLoadType.Carousel : eLazyLoadType.Default
                }
            };
        ...
        public ActionResult NewsBlock()
        {
            ...
            return PartialView("NewsBlock", new NewsBlockViewModel()
            {
                Items = news,
                HideDate = SettingsNews.HideNewsDate
            });
