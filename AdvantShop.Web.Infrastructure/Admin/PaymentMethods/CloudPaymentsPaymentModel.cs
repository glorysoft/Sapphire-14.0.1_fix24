...
namespace AdvantShop.Web.Infrastructure.Admin.PaymentMethods
{
    ...
    public class CloudPaymentsPaymentModel : PaymentMethodAdminModel, IValidatableObject
    {
        ...
        {
            get { return new Tuple<string, string>($"{LinkService.Internal.AccountPlatform}/help/pages/connect-cloudpayments", "Инструкция. Подключение к сервису Cloud Payments."); }
        }
