...
namespace AdvantShop.Web.Infrastructure.Admin.PaymentMethods
{
    ...
    public class WalletOneCheckoutPaymentModel : PaymentMethodAdminModel, IValidatableObject
    {
        ...
        {
            get { return new Tuple<string, string>($"{LinkService.Internal.AccountPlatformNotSecure}/help/pages/connect-wallet-one", "Инструкция. Подключение платежного модуля \"Единая касса\" Wallet one"); }
        }
