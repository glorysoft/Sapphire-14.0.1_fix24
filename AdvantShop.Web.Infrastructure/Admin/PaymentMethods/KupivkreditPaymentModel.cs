...
namespace AdvantShop.Web.Infrastructure.Admin.PaymentMethods
{
    ...
    public class KupivkreditPaymentModel : PaymentMethodAdminModel, IValidatableObject
    {
        ...
        {
            get { return new Tuple<string, string>($"{LinkService.Internal.AccountPlatformNotSecure}/help/pages/buy-in-credit", "Инструкция. Подключение платежного модуля \"Купи в кредит (Тинькофф долями)\""); }
        }
