...
namespace AdvantShop.Web.Infrastructure.Admin.PaymentMethods
{
    ...
    public class PaymasterPaymentModel : PaymentMethodAdminModel, IValidatableObject
    {
        ...
        {
            get { return new Tuple<string, string>($"{LinkService.Internal.AccountPlatformNotSecure}/help/pages/connect-paymaster", "Инструкция. Подключение к сервису PayMaster."); }
        }
