...
$backupPath = $chekoutpath + "\DataBase\AdvantShop_12.0.0_empty.bak"
...
try 
{
	...
	$exclude = @('AdvantShop.sln.metaproj','AdvantShop.sln.metaproj.tmp', 'Web.ConnectionString.config')
	$excludeMatch = @('\bin\','\obj\','\errlog\', '\.idea\')
