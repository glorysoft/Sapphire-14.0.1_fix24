...
namespace AdvantShop.Core.Test.ExtensionsForTests
{

	// https://gist.github.com/NickStrupat/39e659e53a7aa000b737
	public static class AutoPropertyExtensions
	{
		...
		public static Boolean IsAnAutoProperty(this PropertyInfo propertyInfo) =>
			propertyInfo.GetBackingField() != null;

		public static Boolean IsBackingFieldOfAnAutoProperty(this FieldInfo propertyInfo) =>
			propertyInfo.GetAutoProperty() != null;
		...
		public static PropertyInfo GetAutoProperty(this FieldInfo fieldInfo)
		{
			...
			if (autoProperty == null)
				return null;
			if (!autoProperty.CanRead
			    || !autoProperty.GetGetMethod(nonPublic: true)
			                    .IsDefined(typeof(CompilerGeneratedAttribute), inherit: true))
				return null;
			return autoProperty;
		}
