...
namespace AdvantShop.Catalog
{
    public class PropertyGroupService
    {
        ...
        {
            return SQLDataAccess.ExecuteReadOne("SELECT TOP 1 * FROM [Catalog].[PropertyGroup] WHERE PropertyGroupId = @PropertyGroupId",
        ...
        {
            return SQLDataAccess.ExecuteReadOne("SELECT TOP 1 * FROM [Catalog].[PropertyGroup] WHERE GroupName = @GroupName",
