...
namespace AdvantShop.Core.Services.Crm.BusinessProcesses
{
    ...
    {
        public override EBizProcessObjectType ObjectType => EBizProcessObjectType.Customer;
    ...
    {
        public override EBizProcessEventType EventType => EBizProcessEventType.MessageReply;
    }
}
