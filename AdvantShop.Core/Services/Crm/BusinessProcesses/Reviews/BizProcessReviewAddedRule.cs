...
namespace AdvantShop.Core.Services.Crm.BusinessProcesses
{
    ...
    {
        public override EBizProcessObjectType ObjectType => EBizProcessObjectType.Review;

        public override EBizProcessEventType EventType => EBizProcessEventType.ReviewAdded;
