...
namespace AdvantShop.Core.Services.Crm.BusinessProcesses
{
    ...
    {
        public override EBizProcessObjectType ObjectType => EBizProcessObjectType.Lead;
    ...
    {
        public override EBizProcessEventType EventType => EBizProcessEventType.LeadCreated;
    }

    public class BizProcessLeadStatusChangedRule : BizProcessLeadRule
    {
        public override EBizProcessEventType EventType => EBizProcessEventType.LeadStatusChanged;
