...
namespace AdvantShop.Core.Services.IPTelephony.Sipuni
{
    ...
    {
        private static readonly string UrlCallNumber = $"{LinkService.ExternalApi.Sipuni}/api/callback/call_number";
        private static readonly string UrlCallTree = $"{LinkService.ExternalApi.Sipuni}/api/callback/call_tree";
