...
namespace AdvantShop.Core.Services.Attachments
{
    ...
    public class CheckoutAttachment : Attachment
    {
        public override AttachmentType Type
        {
            get { return AttachmentType.Checkout; }
        }
    }

    public class CustomerOrderAttachment : Attachment
    {
        public override AttachmentType Type
        {
            get { return AttachmentType.CustomerOrderFile; }
        }
    }

    public class AdminOrderAttachment : Attachment
    {
        public override AttachmentType Type
        {
            get { return AttachmentType.AdminOrderFile; }
        }
    }
}
