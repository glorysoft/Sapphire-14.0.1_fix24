namespace AdvantShop.CriticalCss
{
    ...
    {
        private const string DomainHeaderKey = "X-Domain";
        private const string ApiAuthHeaderKey = "x-api-key";
        private const int GetDataAttempts = 10;
        private const int CountBundlesPerRequest = 5;
        private const string CriticalCssPrefix = "CriticalCss_";
        private const string CriticalCssDevicePrefix = "CriticalCssDevice_";
        private const string CriticalCssTemplatePrefix = "CriticalCssTemplate_";
        private const string DefaultLandingCss =
