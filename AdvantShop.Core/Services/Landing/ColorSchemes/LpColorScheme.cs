namespace AdvantShop.Core.Services.Landing.ColorSchemes
{
    public class LpColorScheme
    {
        ...
        public string ButtonTextColorActive { get; set; }
        ...
        public string ButtonSecondaryTextColorActive { get; set; }
