    ...
    public class NewsService
    {
        ...
        public static int InsertNewsCategory(NewsCategory newsCategory)
        {
            ...
            if (newsCategory.Meta != null 
                && !newsCategory.Meta.IsDefaultMeta 
                && newsCategory.Meta.IsNotEmpty())
            {
                MetaInfoService.InsertMetaInfo(newsCategory.Meta, id);
            }
            return id;
        }
        ...
        public static void UpdateNewsCategory(NewsCategory newsCategory)
        {
            ...
            if (newsCategory.Meta != null)
            {
                if (newsCategory.Meta.IsNotEmpty())
        ...
        public static int InsertNews(NewsItem news)
        {
            ...
            // ---- Meta
            if (news.Meta != null 
                && !news.Meta.IsDefaultMeta 
                && news.Meta.IsNotEmpty())
            {
                MetaInfoService.InsertMetaInfo(news.Meta, id);
            }
        ...
        public static NewsItem GetFirstNewsItem()
        {
            var id = SQLDataAccess.ExecuteScalar<int>(
                @"SELECT TOP(1) [NewsID]
                FROM [Settings].[News]
