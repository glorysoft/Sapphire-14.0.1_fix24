...
namespace AdvantShop.Shipping.Usps
{
    ...
    public class Usps : BaseShipping
    {
        ...
        private static readonly string UrlDomenic = 
            $"{LinkService.ShippingMethod.Usps}/ShippingAPI.dll?API=RateV4&XML=";
        private static readonly string UrlInternational = 
            $"{LinkService.ShippingMethod.Usps}/ShippingAPI.dll?API=IntlRateV2&XML=";
