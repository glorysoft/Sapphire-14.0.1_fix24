...
namespace AdvantShop.Core.Services.Shipping.Grastin.Api
{
    ...
    public enum EnApiMethod
    {
        ...
        [XmlEnum(Name = "newordercdek")]
        [EnumMember(Value = "newordercdek")]
        NewOrderCdek,
        ...
        [XmlEnum(Name = "cdekselfpickup")]
        [EnumMember(Value = "cdekselfpickup")]
        CdekSelfPickup,

        [XmlEnum(Name = "cdekcity")]
        [EnumMember(Value = "cdekcity")]
        CdekCities,
