...
namespace AdvantShop.Core.Services.Shipping.Grastin.Api
{
    ...
    public class CalcShippingCostContainer : GrastinBaseObject
    {
        [XmlElement("Method")]
        public override EnApiMethod Method
        {
            get { return EnApiMethod.CalcShippingCost; }
            set { throw new NotSupportedException("Setting the Method property is not supported"); }
        }

        [XmlArray("Orders")]
        [XmlArrayItem("Order")]
        public List<CalcShippingCostOrder> Orders { get; set; }
    }

    public class CalcShippingCostOrder
    {
        /// <summary>
        ...
        /// <summary>
        /// Индекса (не документированный параметр)
        /// </summary>
