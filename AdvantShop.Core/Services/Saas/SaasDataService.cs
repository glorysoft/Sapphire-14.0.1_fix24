...
namespace AdvantShop.Saas
{
    public class SaasDataService
    {
        ...
        private static string RequestUrl => $"{LinkService.Internal.ApiServiceNotSecure}/Saas/GetParams/";
        ...
        public static SaasData GetNextSaasDataFromService()
        {
            try
            {
                ...
                var request = WebRequest.Create($"{LinkService.Internal.ApiServiceNotSecure}/Saas/GetNextPlanParams/" + key);
                request.Method = "GET";
        ...
        public static string GetMyAccountLink()
        {
            ...
            return LinkService.Internal.AccountPlatform +
