...
namespace AdvantShop.Notifications
{
    public class AdminMessagesService
    {
        ...
        private static readonly string Url_GetAdminMessagesIds = 
            $"{LinkService.Internal.ApiServiceNotSecure}/AdminMessage/GetActiveAdminMessagesIds/{{0}}";
        private static readonly string Url_GetAdminMessages = 
            $"{LinkService.Internal.ApiServiceNotSecure}/AdminMessage/GetAdminMessages/{{0}}";
        private static readonly string Url_GetListAdminMessages = 
            $"{LinkService.Internal.ApiServiceNotSecure}/AdminMessage/GetListActiveAdminMessages/{{0}}";
        private static readonly string Url_GetAdminMessage = 
            $"{LinkService.Internal.ApiServiceNotSecure}/AdminMessage/GetAdminMessage?id={{0}}&amId={{1}}";
